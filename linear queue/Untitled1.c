...
struct node co[Max];
int slo=84,id=101,t1=1,t2=1,t3=1,t4=1,t5=1,t6=1,t7=1,t8=1,t9=1,t10=1,t11=1,t12=1;
void check();
void book(int i);
void ti();
void hb();
...
void main()
{
    ...
    while(1)
    {
        ...
        case 3:
            ...
            break;
        case 4:
            printf("Total customer of the day is :%d",i-1);
            break;
        case 5:
            hb();
            break;
    ...
    if(slo!=0)
{
    ...
    while(c)
    {
        ...
        case 1:
         ...
         printf("Order more dish? 1=Yes 0=No");
         scanf("%d",&c);
    ...
    int r=table(s1);
    if(r==99)
        printf("There is no table in this particular slot ");
    else
    {
...
{ int j;
    for(j=1;j<=i;j++)
{
    printf(" \t  customer id is:%s",co[j].cid);
...
void ti()
{
    ...
    for(j=1;j<=Max;j++)
     sum=sum+co[j].b;
     printf("Total collection of the day:%d",sum);
}
void hb()
{
    int max=0,j;
